...
<html lang="en">
  <head>
    ...
    <link href="../../partials/altbs.css" rel="stylesheet">
            ...
            <form class="container-fluid rounded-0 p-0 m-0 text-dark align-self-stretch" style="background-color: white;">
              ...
              <div class="row">
                ...
                <div class="mb-3 col-sm-6">
                  ...
                  <input type="text" class="form-control rounded-0" id="fullhname" placeholder="Landmark or well known nearby site" aria-describedby="emailHelp">
                </div>
                <div class="mb-3 col-sm-6">
                  <label for="fullname" class="form-label"><b>VILLAGE/CITY/TOWN</b></label>
                  <input list="VillNames" name="browser" class="form-control rounded-0" id="browser" placeholder="Please start typing to get suggestion" onkeyup="showUser(this.value)">
                  <datalist id="VillNames">
                  <div id="txtHint"></div>
                  </datalist>
                </div>
                <div class="mb-3 col-sm-6">
                  <label for="fullname" class="form-label"><b>TEHSIL</b></label>
                  <input type="text" class="form-control rounded-0" id="fullname" placeholder="Tehsil" aria-describedby="emailHelp">
                </div>
                <div class="mb-3 col-sm-6">
                  <label for="fullname" class="form-label"><b>BLOCK</b></label>
                  <input type="text" class="form-control rounded-0" id="fullname" placeholder="Block" aria-describedby="emailHelp">
                </div>
                <div class="mb-3 col-sm-6">
                  <label for="fullname" class="form-label"><b>DISTRICT</b></label>
                  <input type="text" class="form-control rounded-0" id="fullname" placeholder="District" aria-describedby="emailHelp">
                </div>
                <div class="mb-3 col-sm-6">
